...
input2 = *input;
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud (new pcl::PointCloud<pcl::PointXYZ>);
    pcl::PointCloud<pcl::PointXYZRGBA>::Ptr origincloud (new pcl::PointCloud<pcl::PointXYZRGBA>);
  ...
  pcl::PointCloud<pcl::PointXYZ >::Ptr filetertemplate(new pcl::PointCloud<pcl::PointXYZ >);
    ...
    pcl::fromROSMsg(input2,*origincloud);

   
  *cloudcolor=*origincloud;
  
pcl::copyPointCloud(*origincloud, *cloud);
